...
# engines/rotor =====================================================
var state = props.globals.getNode("sim/model/ka50/state");
var engine = props.globals.getNode("sim/model/ka50/engine");
...
var turbine = props.globals.getNode("sim/model/ka50/turbine-rpm-pct", 1);
var torque_pct = props.globals.getNode("sim/model/ka50/torque-pct", 1);
...
var rotor_step = props.globals.getNode("sim/model/ka50/rotor-step-deg");
